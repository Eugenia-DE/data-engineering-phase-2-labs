CREATE TABLE rentaldb.apartment_attributes (
    id INT PRIMARY KEY,
    category VARCHAR(50),
    body TEXT,
    amenities TEXT,
...
CREATE TABLE rentaldb.apartments (
    id INT PRIMARY KEY,
    title VARCHAR(255),
    source VARCHAR(100),
    price DECIMAL(10,2),
...
CREATE TABLE rentaldb.user_viewing (
    user_id INT,
    apartment_id INT,
    ...
    FOREIGN KEY (apartment_id) REFERENCES rentaldb.apartment_attributes(id)
);
CREATE TABLE rentaldb.bookings (
    ...
    FOREIGN KEY (apartment_id) REFERENCES rentaldb.apartments(id)
);